...
<head>
    ...
    <title>Login - Popular Movies Analytics Dashboard</title>
...
<body class="flex justify-center items-center h-screen bg-gradient-to-r from-gray-900 to-gray-700 text-white">
    <div class="bg-black bg-opacity-80 p-8 rounded-lg shadow-lg w-full max-w-md text-center">
        <h1 class="text-2xl font-bold text-yellow-400 mb-6">Log In</h1>
        ...
        <p class="mt-4 text-sm">Don't have an account? <a href="{{ route('signup') }}" class="text-yellow-400 hover:underline">Sign up</a></p>
    </div>
</body>
</html>
